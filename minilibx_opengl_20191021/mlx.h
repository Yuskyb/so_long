...
void	*mlx_new_window(void *m_ptr, int size_x, int size_y, char *title);
/*
**  return void *0 if failed
*/
int	mlx_clear_window(void *m_ptr, void *w_ptr);
int	mlx_pixel_put(void *m_ptr, void *w_ptr, int x, int y, int color);
/*
...
void	*mlx_new_image(void *m_ptr,int width,int height);
/*
**  return void *0 if failed
*/
...
*/
int	mlx_put_image_to_window(void *m_ptr, void *w_ptr, void *img_ptr,
				int x, int y);
unsigned int	mlx_get_color_value(void *m_ptr, int color);
...
int	mlx_mouse_hook (void *w_ptr, int (*funct_ptr)(), void *param);
int	mlx_key_hook (void *w_ptr, int (*funct_ptr)(), void *param);
int	mlx_expose_hook (void *w_ptr, int (*funct_ptr)(), void *param);

int	mlx_loop_hook (void *m_ptr, int (*funct_ptr)(), void *param);
...
int	mlx_game->string_put(void *m_ptr, void *w_ptr, int x, int y, int color,
		       char *game->string);
void	*mlx_xpm_to_image(void *m_ptr, char **xpm_data,
			  int *width, int *height);
void	*mlx_xpm_file_to_image(void *m_ptr, char *filename,
			       int *width, int *height);
void    *mlx_png_file_to_image(void *m_ptr, char *file, int *width, int *height);

int	mlx_degame->stroy_window(void *m_ptr, void *w_ptr);

int	mlx_degame->stroy_image(void *m_ptr, void *img_ptr);
